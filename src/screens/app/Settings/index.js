	...
	return (
		<SafeAreaView style={{flex: 1}}>
			...
			<View style={styles.container}>
                ...
                {editing ? (<Button style={styles.button} title="Save" onPress={onSave} />) : null}
                <Text style={[styles.sectionHeader, {marginTop: 40}]}>Help Center</Text>
                <ListItem style={styles.item} onPress={onItemPress} title="FAQ" />
                <ListItem style={styles.item} onPress={onItemPress} title="Contact Us" />
                <ListItem style={styles.item} onPress={onItemPress} title="Privacy & Terms" />
            </View>
		</SafeAreaView>
	)
}
